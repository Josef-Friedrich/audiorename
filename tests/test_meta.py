...
class TestEnrichMetadata(unittest.TestCase):
    def test_enrich_metadata_meistersinger(self):
        ...
        meta = Meta(tmp)
        self.assertEqual(meta.mb_trackid, "00ba1660-4e35-4985-86b2-8b7a3e99b1e5")
        self.assertEqual(meta.mb_workid, None)
        self.assertEqual(meta.work, None)

        meta.enrich_metadata()
        self.assertEqual(meta.mb_workid, "6b198406-4fbf-3d61-82db-0b7ef195a7fe")
        self.assertEqual(
            meta.work, "Die Meistersinger von Nürnberg, " "WWV 96: Vorspiel"
        )
        meta.save()

        finished = Meta(tmp)
        self.assertEqual(finished.mb_workid, "6b198406-4fbf-3d61-82db-0b7ef195a7fe")
        self.assertEqual(
            finished.work, "Die Meistersinger von Nürnberg, " "WWV 96: Vorspiel"
        )
        self.assertEqual(
    ...
    def test_enrich_metadata_pulp(self):
        ...
        meta = Meta(tmp)
        self.assertEqual(meta.mb_trackid, "0480672d-4d88-4824-a06b-917ff408eabe")
        self.assertEqual(meta.mb_workid, None)
        self.assertEqual(meta.work, None)
...
class TestRemapClassical(unittest.TestCase):
    ...
    def test_remap_classical(self):
        ...
        self.assertEqual(
            self.meta.album, "4 Hornkonzerte (Concertos for Horn " "and Orchestra)"
        )
        self.assertEqual(
            self.meta.comments,
            "Orpheus Chamber Orchestra, " "David Jolley, William Purvis",
        )
        ...
        self.assertEqual(
            finished.album,
            "Concerto for Horn no. 3 in E-flat " "major, K. 447 (OrpChaOrc)",
        )
        self.assertEqual(
            finished.comments,
...
class TestPropertyAlbumClean(unittest.TestCase):
    ...
    def test_real_world(self):
        ...
        self.assertEqual(meta.ar_combined_album, "The Greatest No.1s of the 80s")
...
class TestPropertyArtistSafeUnit(unittest.TestCase):
    ...
    def test_shell_unfriendly(self):
        ...
        self.assertEqual(self.meta.ar_combined_artist_sort, "Lastname, Prename")
...
class TestPropertyWork(unittest.TestCase):
    def test_work(self):
        ...
        self.assertEqual(meta.mb_workid, "21fe0bf0-a040-387c-a39d-369d53c251fe")
...
class TestAllPropertiesWagner(unittest.TestCase):
    ...
    def test_ar_classical_album(self):
        self.assertEqual(self.meta.ar_classical_album, "Die Meistersinger von Nürnberg")

    def test_ar_combined_album(self):
        self.assertEqual(self.meta.ar_combined_album, "Die Meistersinger von Nürnberg")
    ...
    def test_ar_performer(self):
        self.assertEqual(
            self.meta.ar_performer, "Herbert von Karajan, Staatskapelle Dresden"
        )

    def test_ar_classical_performer(self):
        self.assertEqual(self.meta.ar_classical_performer, "Karajan, StaDre")

    def test_ar_performer_raw(self):
        self.assertEqual(
            self.meta.ar_performer_raw,
            [
                ["conductor", "Herbert von Karajan"],
                ["orchestra", "Staatskapelle Dresden"],
            ],
    ...
    def test_ar_performer_short(self):
        self.assertEqual(self.meta.ar_performer_short, "Karajan, StaDre")
...
class TestClassical(unittest.TestCase):
    ...
    def test_ar_classical_album_schubert(self):
        self.assertEqual(
            self.schubert.ar_classical_album, "Die Winterreise, op. 89, D. 911"
        )

    def test_ar_classical_album_tschaikowski(self):
        self.assertEqual(self.tschaikowski.ar_classical_album, "Swan Lake, op. 20")

    def test_ar_classical_album_wagner(self):
        self.assertEqual(
            self.wagner.ar_classical_album, "Die Meistersinger von N\xfcrnberg"
        )
    ...
    def test_ar_combined_composer_mozart(self):
        self.assertEqual(self.mozart.ar_combined_composer, "Mozart, Wolfgang Amadeus")

    def test_ar_combined_composer_mozart2(self):
        self.assertEqual(self.mozart2.ar_combined_composer, "Mozart, Wolfgang Amadeus")

    def test_ar_combined_composer_schubert(self):
        self.assertEqual(self.schubert.ar_combined_composer, "Schubert, Franz")

    def test_ar_combined_composer_tschaikowski(self):
        self.assertEqual(
            self.tschaikowski.ar_combined_composer, "Tchaikovsky, Pyotr Ilyich"
        )

    def test_ar_combined_composer_wagner(self):
        self.assertEqual(self.wagner.ar_combined_composer, "Wagner, Richard")

    # composer_sort
    def test_composer_sort_mozart(self):
        self.assertEqual(self.mozart.composer_sort, "Mozart, Wolfgang Amadeus")

    def test_composer_sort_schubert(self):
        self.assertEqual(self.schubert.composer_sort, "Schubert, Franz")

    def test_composer_sort_tschaikowski(self):
        self.assertEqual(self.tschaikowski.composer_sort, "Tchaikovsky, Pyotr Ilyich")

    def test_composer_sort_wagner(self):
        self.assertEqual(self.wagner.composer_sort, "Wagner, Richard")

    # ar_classical_performer
    def test_ar_classical_performer_mozart(self):
        self.assertEqual(self.mozart.ar_classical_performer, "OrpChaOrc")

    def test_ar_classical_performer_schubert(self):
        self.assertEqual(self.schubert.ar_classical_performer, "Fischer-Dieskau, Moore")

    def test_ar_classical_performer_tschaikowski(self):
        self.assertEqual(
            self.tschaikowski.ar_classical_performer, "Svetlanov, StaAcaSym"
        )

    def test_ar_classical_performer_wagner(self):
        self.assertEqual(self.wagner.ar_classical_performer, "Karajan, StaDre")
    ...
    def test_ar_classical_title_schubert(self):
        self.assertEqual(self.schubert.ar_classical_title, "Gute Nacht")
    ...
    def test_ar_classical_title_wagner(self):
        self.assertEqual(self.wagner.ar_classical_title, "Vorspiel")
