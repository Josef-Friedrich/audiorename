...
class TestFunctionBestFormat(unittest.TestCase):
    ...
    * mp3_320.mp3 319999
    ...
    def test_type_target_better(self):
        ...
        self.assertEqual(
            output[0],
            "Best format is “target” because of “type”: " "(source: mp3, target: flac)",
        )
    ...
    def test_type_source_better(self):
        ...
        self.assertEqual(
            output[0],
            "Best format is “source” because of “type”: " "(source: flac, target: mp3)",
        )
    ...
    def test_bitrate_mp3_source_better(self):
        ...
        self.assertEqual(
            output[0],
            "Best format is “source” because of “bitrate”: "
    ...
    def test_bitrate_mp3_target_better_2(self):
        ...
        self.assertEqual(
            output[0],
            "Best format is “target” because of “bitrate”: "
...
class TestBasicRename(unittest.TestCase):
    ...
    def test_album(self):
        ...
        self.assertTrue(helper.is_file(helper.dir_cwd + helper.path_album))

    def test_compilation(self):
        self.assertFalse(os.path.isfile(self.tmp_compilation))
        self.assertTrue(helper.is_file(helper.dir_cwd + helper.path_compilation))
