...
class TestAllFields(unittest.TestCase):
    ...
    def test_Yesterday(self):
        ...
        self.assertEqual(meta.mb_albumartistid, "b10bbbfc-cf9e-42e0-be17-e2c3e1d2600d")
        self.assertEqual(meta.mb_albumid, "95e9dc60-a6d9-315f-be99-bd5b69a6582f")
        self.assertEqual(meta.mb_artistid, "b10bbbfc-cf9e-42e0-be17-e2c3e1d2600d")
        self.assertEqual(meta.mb_releasegroupid, "0d44e1cb-c6e0-3453-8b68-4d2082f05421")
        self.assertEqual(meta.mb_trackid, "c05194a3-f6f0-4f52-b78a-13fb5580bc0f")
    ...
    def test_Nachtmusik(self):
        ...
        self.assertEqual(
            meta.ar_combined_artist,
            "Wolfgang Amadeus Mozart; Berliner " "Philharmoniker, Herbert von Karajan",
        )
        self.assertEqual(
            meta.ar_combined_artist_sort,
            "Mozart, Wolfgang Amadeus; "
            "Berliner Philharmoniker, Karajan, Herbert von",
        )
        ...
        self.assertEqual(meta.lyricist, None)
        self.assertEqual(meta.lyrics, None)
        self.assertEqual(meta.mb_albumartistid, "b972f589-fb0e-474e-b64a-803b0364fa75")
        self.assertEqual(
            meta.mb_albumartistids,
            [
        ...
        self.assertEqual(meta.mb_albumid, "73678131-46a7-442b-8cce-27a8b3bf99c7")
        self.assertEqual(meta.mb_artistid, "b972f589-fb0e-474e-b64a-803b0364fa75")
        self.assertEqual(meta.mb_releasegroupid, "17267766-771b-45fe-969f-14b9c4b15e4a")
        self.assertEqual(meta.mb_trackid, "0db2cdc3-8272-44ef-9810-c75c3939ece8")
        self.assertEqual(meta.mb_workid, None)
        self.assertEqual(meta.media, "CD")
        ...
        self.assertEqual(
            meta.ar_classical_performer, "Berliner Philharmoniker, Herbert von Karajan"
        )
        self.assertEqual(meta.r128_album_gain, None)
        self.assertEqual(meta.r128_track_gain, None)
        self.assertEqual(meta.rg_album_gain, None)
