...
class TestEnrich(unittest.TestCase):
    ...
    def test_release_pulp_01(self):
        ...
        self.assertEqual(
            result["release-group"]["id"], "1703cd63-9401-33c0-87c6-50c4ba2e0ba8"
        )
    ...
    def test_release_mozart_01(self):
        ...
        self.assertEqual(
            result["release-group"]["id"], "e1fa28f0-e56e-395b-82d3-a8de54e8c627"
        )
    ...
    def test_work_mozart_zauberfloete_unit(self):
        ...
        self.assertEqual(result[0]["id"], "eafec51f-47c5-3c66-8c36-a524246c85f8")
        self.assertEqual(result[1]["id"], "5adc213f-700a-4435-9e95-831ed720f348")
        self.assertEqual(result[2]["id"], "e208c5f5-5d37-3dfc-ac0b-999f207c9e46")
    ...
    def test_work_kempff_transcription(self):
        ...
        self.assertEqual(result[0]["id"], "4fba670e-3b8e-4ddf-a3a6-90817c94d6ce")
