...
class TestEnrich:
    ...
    def test_recording_pulp_01(self) -> None:
    ...
    def test_recording_mozart_01(self) -> None:
    ...
    def test_release_pulp_01(self) -> None:
        # ['soundtrack', 'Pulp-Fiction', '01.mp3']
        result = query(
            "release",
    ...
    def test_release_mozart_01(self) -> None:
        # ['classical', 'Mozart_Horn-concertos', '01.mp3'])
        result = query(
            "release",
    ...
    def test_work_mozart_zauberfloete_unit(self) -> None:
    ...
    def test_work_kempff_transcription(self) -> None:
