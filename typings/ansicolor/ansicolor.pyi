...
__all__ = ["black", "blue", "cyan", "green", "magenta", "red", "white", "yellow", "colorize", "colorize_v2", "wrap_string", "get_code", "get_code_v2", "highlight_string", "get_highlighter", "strip_escapes", "justify_formatted", "colordiff", "set_term_title", "write_out", "write_err", "Colors"]
_disabled = ...
class Colors:
    """Container class for colors"""
    @classmethod
    def new(cls, colorname): # -> None:
        ...
    
    @classmethod
    def iter(cls): # -> Generator[Unknown, None, None]:
        ...
    


def make_func(color): # -> (s: Unknown, bold: bool = False, reverse: bool = False) -> str:
    ...
...
def colorize_v2(s, color, bold=..., reverse=..., underline=..., blink=..., start=..., end=...): # -> str:
    """
    Colorize a string with the color given.
